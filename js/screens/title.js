game.TitleScreen = me.ScreenObject.extend({
 init: function() {
    ...
    onResetEvent: function() {
        ...
        // PlayAgain button
        this.btnPlayNow = new btnPlayNow(me.game.viewport.width / 2 - 60, me.game.viewport.height / 2);
        me.game.world.addChild(this.btnPlayNow, 12);
        ...
        this.dialog = new (me.Renderable.extend({
            ...
            init: function() {
                ...
                this.notice_1 = 'Thoát Khỏi Mê Cung';
                ...
                this.notice_3 = 'Nhấn Play Now để bắt đầu';
                this.font_notice_3 = new me.Font("Arial", 30, "#d09b2c", "center");
...
var btnPlayNow = me.GUI_Object.extend({
    init: function(x, y) {
    	
        var settings = {};
        settings.image = "btnplaynow";
